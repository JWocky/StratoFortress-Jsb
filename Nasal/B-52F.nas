...
print("starting engines");
	...
	settimer(eng5start, 36);
	settimer(eng6start, 42);
	settimer(eng7start, 48);
	settimer(eng8start, 54);

	settimer(eng1norm, 16);
	settimer(eng2norm, 22);
	settimer(eng3norm, 28);
	settimer(eng4norm, 34);
	settimer(eng5norm, 40);
	settimer(eng6norm, 46);
	settimer(eng7norm, 52);
	settimer(eng8norm, 58);

	settimer(eng1watch, 20);
	settimer(eng2watch, 26);
	settimer(eng3watch, 32);
	settimer(eng4watch, 38);
	settimer(eng5watch, 44);
	settimer(eng6watch, 50);
	settimer(eng7watch, 56);
	settimer(eng8watch, 62);
